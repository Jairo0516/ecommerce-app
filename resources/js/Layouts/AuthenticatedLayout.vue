...
<template>
    ...
    <main>
        ...
        <!-- Page Heading -->
        <header class=" dark:bg-gray-800 bg-white relative overflow-hidden h-24 sm:h-32 flex items-center z-30 w-full">
            <div class="container mx-auto px-6 flex items-center justify-between">
                ...
                <div class="flex items-center">
                    <nav class="font-sen text-gray-800 dark:text-white uppercase text-lg lg:flex items-center hidden">
                        <a :href="route('dashboard')" class="py-2 px-6 flex">
                            Home
                        </a>
                        <a :href="route('product/list')" class="py-2 px-6 flex">
                            Product
                        </a>
                        <a href="#" class="py-2 px-6 flex">
                            Contact
                        </a>
                        <a v-if="$page.props.auth.user.user_type === 1" :href="route('report/list')"
    ...
    <footer>
        <div class="fixed bottom-4 right-4">
            <button
                ...
                <img class="w-6 h-6"
                     src="https://st2.depositphotos.com/1114422/5830/v/450/depositphotos_58300529-stock-illustration-check-out-icon-symbol.jpg"
